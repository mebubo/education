...
def Pwin3(me, you, pending):
    ...
    if me + pending >= goal:
        ...
        def Phold(): return 1 - Pwin3(you, me+pending, 0)
        def Proll(): return (1 - Pwin3(you, me+1, 0) +
                             sum(Pwin3(me, you, pending+d) for d in range(2,7))) / 6.
        return max(Phold(), Proll()) if pending else Proll()
